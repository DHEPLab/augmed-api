...
def test_invalid_user_email_raises_exception():
    ...
    writer = csv.writer(stream, delimiter=",")
    writer.writerow(['User', 'Case No.', 'Path', 'Collapse', 'Highlight', 'Top'])
    writer.writerow([None, '1', 'Background.patient demo', None, None, None])  # Invalid user
    stream.seek(0)
...
def test_invalid_case_id_raises_exception():
    ...
    writer = csv.writer(stream, delimiter=",")
    writer.writerow(['User', 'Case No.', 'Path', 'Collapse', 'Highlight', 'Top'])
    writer.writerow(['usera@example.com', 'abc', 'Background.patient demo', None, None, None])  # Invalid case ID
    stream.seek(0)
...
def test_invalid_non_number_top_config_should_raises_exception():
    ...
    writer = csv.writer(stream, delimiter=",")
    writer.writerow(['User', 'Case No.', 'Path', 'Collapse', 'Highlight', 'Top'])
    writer.writerow(['uset@test.com', '1', 'Background.patient demo', None, None, 'abc'])
    stream.seek(0)
