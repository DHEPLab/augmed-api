...
from src.configration.utils.answer_config_validations.multiple_choice import multiple_choice_type_validate
...
class TestMultipleChoiceTypeValidate(unittest.TestCase):
    def test_valid_data(self):
        ...
        try:
            ...
            self.fail("multiple_choice_type_validate() raised BusinessException unexpectedly!")
    ...
    def test_missing_title(self):
        ...
        self.assertEqual(cm.exception.detail, "A question title is required in multiple choice.")
