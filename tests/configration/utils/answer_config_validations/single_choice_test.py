...
from src.configration.utils.answer_config_validations.single_choice import single_choice_type_validate
...
class TestSingleChoiceTypeValidate(unittest.TestCase):
    def test_valid_data(self):
        ...
        try:
            ...
            self.fail("single_choice_type_validate() raised BusinessException unexpectedly!")
