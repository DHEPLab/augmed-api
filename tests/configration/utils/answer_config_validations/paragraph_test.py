...
from src.configration.utils.answer_config_validations.paragraph import (
    paragraph_type_validate,
)
...
class TestParagraphTypeValidate(unittest.TestCase):
    ...
    def test_valid_data(self):
        ...
        try:
            ...
            self.fail(
                "paragraph_type_validate() raised BusinessException unexpectedly!"
            )
    ...
    def test_missing_title(self):
        ...
        self.assertEqual(
            cm.exception.detail, "A question title is required in paragraph."
        )
