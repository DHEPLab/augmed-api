...
class TestValidateFactory(unittest.TestCase):
    ...
    def test_text_type_validate(self):
        ...
        with patch(
            "src.configration.utils.answer_config_validations.validation_factory.text_type_validate"
        ) as mock_text_type_validate:
    ...
    def test_paragraph_type_validate(self):
        ...
        with patch(
            "src.configration.utils.answer_config_validations.validation_factory.paragraph_type_validate"
        ) as mock_paragraph_type_validate:
            validate_factory(item)
    ...
    def test_single_choice_type_validate(self):
        ...
        with patch(
            "src.configration.utils.answer_config_validations.validation_factory.single_choice_type_validate"
        ) as mock_single_choice_type_validate:
            validate_factory(item)
    ...
    def test_multiple_choice_type_validate(self):
        ...
        with patch(
            "src.configration.utils.answer_config_validations.validation_factory.multiple_choice_type_validate"
        ) as mock_multiple_choice_type_validate:
            validate_factory(item)
    ...
    def test_invalid_type(self):
        ...
        with pytest.raises(
            BusinessException,
            match=re.compile(BusinessExceptionEnum.InValidAnswerConfig.name),
        ):
            validate_factory(item)
